...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_LESS_THAN = new Prefix("lt|");
    public static final Prefix PREFIX_MORE_THAN = new Prefix("mt|");

    public static final Prefix PREFIX_SPECIAL = new Prefix("|");
}
